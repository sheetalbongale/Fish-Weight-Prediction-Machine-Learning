...
df_participant, df_holdout = train_test_split(
    df, random_state=42, test_size=0.3, stratify=df["Species"]
)
...
_, df_demo_holdout = train_test_split(
    df_participant, random_state=123, stratify=df_participant["Species"]
)
